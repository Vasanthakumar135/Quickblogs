...
const AddBlog = () => {
  ...
  useEffect(() => {
    // Initiate Quill only once with Headings, Bold, Italic, and Numbered List
  ...
  return (
    <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50 flex-1 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <button disabled={isAdding} type='submit' className='mt-8 w-40 h-10 bg-primary text-white rounded-xl cursor-pointer text-sm'>
